...
export default {
  ...
  data() {
    return {
      ...
      // onSale: true,
      details: ["강동원 배우", "예쁘고 서늘한 영화", "감성 판타지 엽서와 퍼즐"],
      variants: [
        {
          id: 2234,
          color: "yellow",
          image: require("../assets/img/Vanishing Time_Postcard.jpg"),
          quantity: 50,
        },
        {
          id: 2235,
          color: "orange",
          image: require("../assets/img/Vanishing Time_Puzzle.jpg"),
          // quantity: 0,
          quantity: 10,
        },
      ],
